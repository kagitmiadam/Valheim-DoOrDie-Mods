...
namespace DoDMonsters
{
    ...
    public class Local
    {
        ...
        private static Dictionary<string, string> russian = new Dictionary<string, string>() {
								...
								{
									"prop_mistlandsoak_dod",
									"Туманные земли Дуб"
								},
								{
									"prop_mistlandsbush_dod",
									"Куст"
								},
								{
									"prop_oldoak_dod",
								...
								{
									"item_trophy_stormling_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_livinglava_dod",
									"Живая Лава"
								},
								{
									"item_trophy_livinglava_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_blackdeer_dod",
									"Голова Черного Оленя"
								},
								{
									"item_trophy_blackdeer_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_obgolem_dod",
									"Голова Обсидианового Голема"
								},
								{
									"item_trophy_obgolem__description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_lavagolem_dod",
									"Голова Лавового Голема"
								},
								{
									"item_trophy_lavagolem_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_icegolem_dod",
									"Голова Ледяного Голема"
								},
								{
									"item_trophy_icegolem_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_livingwater_dod",
									"Живая Вода"
								},
								{
									"item_trophy_livingwater_description",
									"Трофей, повесь его у себя на стене."
								},
								{
									"item_trophy_gsurtling_dod",
									"Голова Великого Суртлинга"
								},
								{
									"item_trophy_gsurtling_description",
									"Трофей, повесь его у себя на стене."
								}
		};
